...
// Previously this used C rand(), whose RAND_MAX on Windows is 32767
// and whose period and distribution are poor; the modulo-10000
// trick also biased the perturbation toward small positive values.
...
{
	// Uniform on [0, 10000) to keep the perturbation magnitude
	// comparable to the prior `rand()%10000` form, but without
	// rand()'s bias and short period.
