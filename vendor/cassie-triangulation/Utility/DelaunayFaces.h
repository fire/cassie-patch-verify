...
// tetrahedralization of an unconstrained point cloud. Replaces the
// tetgenio in/out + ::tetrahedralize("Qf", ...) pattern that the rest
// of this codebase used while it depended on AGPL TetGen.
//
// Backed by Geogram (BSD-3) GEO::Delaunay3d ("BDEL").
