...
// Vendored from godot/modules/cassie/src/solver/slang_dispatch/curve_rdp_dispatch.cpp
// Include path adjusted for cassie-patch-verify vendor layout.

#include "curve_rdp_dispatch.h"

// curve_rdp.cpu.cpp's own relative include "../slang-prelude/slang-cpp-prelude.h"
// resolves from vendor/curve_rdp/ → vendor/slang-prelude/ ✓
#include "../vendor/curve_rdp/curve_rdp.cpu.cpp"
